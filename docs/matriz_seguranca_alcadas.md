...
| faturamento | fiscal/financeiro/comercial autorizado ve dossie fiscal por pedido, romaneio e cliente | emissao, remessa dependente, cancelamento, carta de correcao, complemento e substituicao por RPC/evento fiscal | nao | `faturamento.nf.view`, `faturamento.nf.issue`, `faturamento.nf.cancel`, `faturamento.nf.correct`, `faturamento.nf.complement`, `faturamento.nf.substitute` | criar tabela de documento fiscal e eventos fiscais; bloquear escrita direta; NF nao e campo de pedido; remessa referencia NF simples pai quando aplicavel |
