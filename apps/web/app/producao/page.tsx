    ...
    >
      ...
      <section className="panel" aria-labelledby="production-flow-title">
        <div className="panel-header">
          ...
          <span className="pill">6 etapas</span>
        </div>
        <div className="operation-card-grid production-stage-grid">
          ...
          <StageCard number="04" title="Ordens e reservas" detail="Abertura de OP e reserva de MP, PA ou PI." href="/pcp#nova-op" status="Proxima fatia" />
      ...
      <section className="panel production-next-band">
        <div>
          ...
          <h2>Ordens de producao e reservas</h2>
          <p className="muted">A proxima fatia separara planejamento, reserva de componentes e fila de OP.</p>
        </div>
        <Link className="secondary-button" href="/pcp#ops">Consultar operacao atual</Link>
      </section>
    </ProductionShell>
  );
}
