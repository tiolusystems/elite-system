...
const FEEDBACK: Record<string, { kind: "ok" | "warning"; title: string; detail: string }> = {
  ...
  stock_entry_created: { kind: "ok", title: "Entrada registrada", detail: "Lote, saldo físico e camada de custo foram gravados na mesma transação." },
  missing_stock_entry: { kind: "warning", title: "Entrada incompleta", detail: "Informe lote do fornecedor, quantidade e documento de entrada." },
  invalid_stock_difal: { kind: "warning", title: "DIFAL inconsistente", detail: "Revise valor, situação, motivo e UF do emitente." },
  invalid_stock_dates: { kind: "warning", title: "Datas inconsistentes", detail: "A validade não pode ser anterior à fabricação." },
  stock_entry_repeated_payload: { kind: "warning", title: "Solicitação já utilizada", detail: "Atualize a tela antes de registrar uma entrada diferente." },
  stock_entry_failed: { kind: "warning", title: "Entrada não registrada", detail: "Revise os dados e sua alçada. Nenhum movimento parcial foi mantido." },
