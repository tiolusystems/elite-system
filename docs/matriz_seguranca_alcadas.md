...
| romaneios | expedicao/comercial ve rascunhos, separacao, entregador, veiculo, situacao fiscal e historico | criar, reservar, atribuir/remover logistica, confirmar, cancelar e estornar por RPC | sim | `romaneios.create`, `romaneios.reserve`, `romaneios.confirm`, `romaneios.cancel`, `romaneios.logistics.assign`, `romaneios.logistics.remove` | leitura por expedicao/comercial; escrita so por RPC; logistica e ledger append-only da DEC-008; NF permanece propriedade de faturamento |
