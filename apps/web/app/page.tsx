  ...
  return (
    <main className="app-shell">
      <section className="workspace dashboard-workspace">
        ...
        {(moduleRuntime || cadastros || pedidos || importacaoXml || kanban || pcp || romaneios || relatorios || seguranca || navigationAccess["/importacao-historica/mp"]) ? <section className="dashboard-grid compact">
