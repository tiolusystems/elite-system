...
- Os formularios de cliente, pessoa comercial, materia-prima, produto-base e embalagem usam Server Actions e funcoes PostgreSQL auditaveis; nao gravar diretamente em tabelas `cad_*` pela UI.
