...
| `/pedidos/financeiro` | comissionados, recebimento, pagamento e ajuste | financeiro autorizado | alçadas financeiras | pedido aprovado e saldo | ledgers append-only | excesso, duplicidade e retry divergente recusados | cadeia comercial | comprovado |
